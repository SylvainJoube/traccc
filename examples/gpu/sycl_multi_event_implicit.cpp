...
{ try {
    ...
    // ============== File IO initialization and csv to binary translation ==============

    std::cout << "CCL SYCL - IMPLICIT USM\n";
   ...
   events = events * repeat_data_count;
    ...
    traccc::multi_event_info hc_info[events]; // control structure
    ...
    for (uint iwarmup_and_final_exec = 0; iwarmup_and_final_exec < warmup_count + 1; ++iwarmup_and_final_exec) {
        ...
        traccc::sycl::ccl::output_module_ctrl *ctrl_output_array = cl::sycl::malloc_shared<traccc::sycl::ccl::output_module_ctrl>(module_count, sycl_q);
        //new traccc::sycl::ccl::output_module_ctrl[module_count];
        ...
        traccc::sycl::ccl::input_cell *input_cell_array = cl::sycl::malloc_shared<traccc::sycl::ccl::input_cell>(total_cell_count, sycl_q);
        //new traccc::sycl::ccl::input_cell[total_cell_count];
        ...
        */
        ...
        sycl_q.parallel_for<MyKernel_a>(cl::sycl::range<1>(module_count), [=](cl::sycl::id<1> module_indexx) {
