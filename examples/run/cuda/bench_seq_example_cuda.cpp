...
int seq_run(const traccc::full_tracking_input_config& i_cfg,
    ...
    traccc::bench_timer::bench_logger bench_logger("bench_cuda.log");
    ...
    bench_logger.flogn(file_reading_cpu,    "file_reading_cpu   ");
    bench_logger.flogn(clusterization_cpu,  "clusterization_cpu ");
    bench_logger.flogn(sp_formation_cpu,    "sp_formation_cpu   ");
    bench_logger.flogn(clusterization_sycl, "clusterization_sycl");
    bench_logger.flogn(seeding_cpu,         "seeding_cpu        ");
    bench_logger.flogn(seeding_cuda,        "seeding_sycl       ");
    bench_logger.flogn(tp_estimating_cpu,   "tp_estimating_cpu  ");
    bench_logger.flogn(tp_estimating_cuda,  "tp_estimating_sycl ");
